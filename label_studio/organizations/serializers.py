...
class OrganizationMemberListSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'organization', 'user', 'role', 'created_at', 'updated_at']
...
class OrganizationMemberSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = OrganizationMember
        fields = ['user', 'organization', 'role', 'contributed_projects_count', 'annotations_count', 'created_at', 'updated_at']
