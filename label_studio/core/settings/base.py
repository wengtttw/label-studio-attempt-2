...
DATABASES_ALL = {
    DJANGO_DB_POSTGRESQL: {
        ...
        'PASSWORD': get_env('POSTGRE_PASSWORD', 'password'),
...
WHOAMI_USER_SERIALIZER = 'users.serializers.UserSerializer'
...
LABEL_STUDIO_ENABLE_LEGACY_API_TOKEN = get_bool_env('LABEL_STUDIO_ENABLE_LEGACY_API_TOKEN', True)
